package com.haga.workshopmongo.config;
...
import com.haga.workshopmongo.dto.AuthorDTO;
import com.haga.workshopmongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2018"),"Partiu viajar", "Vou viajar para São Paulo", new AuthorDTO(maria));
